...
class PopclassTargetResponseTest {
    ...
    void mapsCurrentTargetsIntoFrontendBucketsAndFields() {
        var current = target("CURRENT_VERSION", 1, 0, 13);
        ...
        assertThat(response.oldSongs().getFirst().medal()).isEqualTo(9);
    }

    @Test
    void mapsLegacyTargetsFromAllTimeValuesAndFrontendMedalCodes() {
        ...
        assertThat(response.medal()).isEqualTo(11);
    }
